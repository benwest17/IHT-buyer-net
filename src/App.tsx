...
function buildPdf(opts: {
  ...
  const rows: Array<[string, string]> = [
    ...
    ["Seller credit", `(${toMoney(opts.sellerCredit)})`],
...
export default function App() {
  ...
  const cashToClose = useMemo(() => round2(downPayment + buyerFeeCalc.total + otherBuyerCostsTotal - earnestMoney - sellerCredit - taxCreditRounded), [downPayment, buyerFeeCalc.total, otherBuyerCostsTotal, earnestMoney, sellerCredit, taxCreditRounded]);
          ...
          <motion.div {...cardMotion} className="lg:col-span-2">
            <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-black/5">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <Field label="Seller credit" hint="Reduces buyer cash to close">
                  <input value={sellerCreditInput} onChange={(e) => setSellerCreditInput(formatInputMoney(e.target.value))} className="w-full rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm outline-none focus:border-neutral-900" inputMode="decimal" />
                </Field>
              </div>
          ...
          <motion.div {...cardMotion} className="lg:col-span-1">
            <div className="sticky top-6 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-black/5">
              ...
              <div className="mt-4 space-y-3">
                ...
                <Row k="Seller credit" v={`(${toMoney(round2(sellerCredit))})`} />
